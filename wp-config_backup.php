...
define('AUTH_KEY',         'H~QqrUgruI[fFvYBP8w50-|rMWuH d5D3]VTp%r7^$}mElm0!-=F`]A3_9X+3zZ)');
define('SECURE_AUTH_KEY',  'svZIehu%VK*0vE9Mu/N>{cso#P.p;i9!uC[)+=lty/z|)V43L:Vy9sh1~%eeyOmM');
define('LOGGED_IN_KEY',    'T^~w%@0cR [m:{-*6L+UVWLp@G_~}j,,4Zb$MbG%DN  a>vb@{&!vnt96|ZoVlV_');
define('NONCE_KEY',        '247|.,5xk@(}84|WwdAUjyN/3t(<D!1+yW[AFiz;nd=NGS0Z^A23217^!{Z2e[[.');
define('AUTH_SALT',        '[5[c(Kt%E{]4JB[ig`0a<C, Z.?uCZed2z#O~>|$m%>u>MI5kAor*l<EO|0_L+O*');
define('SECURE_AUTH_SALT', '6R$aLyYOLZ!MbC-+5ss7n{=,z/HR 5y/wll%Ve,#-oqt0}rW}x0)jgA1EVZR@5?,');
define('LOGGED_IN_SALT',   'Pn]Gk}|8iJAF:-Z/c69CJ4#}4~~AYY|{yv&]-Wdp/Ch5N`ASFh1 &|?#j!_?];+r');
define('NONCE_SALT',       ':K>1T&L&I${UMEiHCV:e%kV#&&}6+-}tqmR#%D.-rqwb]kW-d]Tn0,cFegyGp!UC');
/**#@-*/
